...
class _ClassroomSubjectState extends State<ClassroomSubject> {
  ...
  // ฟังก์ชันตัดเอาตัวอักษรแรกชื่อ + นามสกุล
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              const Text('ห้องเรียน', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                              GestureDetector(
                                onTap: () {
                          ...
                          Column(
                            children: const [
                              Text('ชื่อวิชา', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                              SizedBox(height: 4),
                              Text('เลขห้องเรียน', style: TextStyle(fontSize: 14, color: Colors.grey)),
                              SizedBox(height: 4),
                              Text('รหัสห้องเรียน', style: TextStyle(fontSize: 14, color: Colors.grey)), // เพิ่มบรรทัดนี้
                            ],
                          ),
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          child: const Padding(
                            ...
                            child: Text('ข้อมูลการเข้าชั้นเรียน', style: TextStyle(color: Colors.white)),
                          ),
                        ),
                        const SizedBox(height: 12),
                        ElevatedButton(
                          ...
                          child: const Padding(
                            padding: EdgeInsets.symmetric(vertical: 14),
                            child: Text('การเช็คชื่อเข้าชั้นเรียน', style: TextStyle(color: Colors.white)),
                          ),
                        ),
                      ],
                    ),
